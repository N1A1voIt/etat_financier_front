...
public class AiService {
    ...
    public String queryChatbot2(String query, String balanceSheet,String compteResultat) {
        ...
        textPart.put("text", "You are a financial analyst. Based on the following financial ratios, the balance sheets and the income statement, provide a detailed interpretation of the company's financial health. "
                + "Explain what each ratio means, whether it is good or bad, and provide actionable recommendations for improvement ,overall tell me what to do with the elements of my balance sheets inside the recommendations.In the solutions use the amounts to explain your solution .Give at list 3 solutions for each"
